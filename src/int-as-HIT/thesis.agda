...
open Preservation-of-Equivalences hiding (s ; p ; σ ; ρ ; τ ; s' ; p' ; σ' ; ρ' ; τ') public
...
-- ?. The Identity Type of Sections

module Section-Id (A' : Alg 𝓤) (E' : FibAlg 𝓥 A') where
  ...
  SecId : AlgSec A' E' → AlgSec A' E' → 𝓤 ⊔ 𝓥 ̇
  SecId (f , f₀ , f-s) (g , g₀ , g-s) = Σ H ꞉ (f ∼ g) , (H a₀ ⁻¹ ∙ f₀ ≡ g₀) × ((a : A) → f-s a ∙ ap (s' a) (H a) ≡ H (s a) ∙ g-s a)

  {- TO DO: EXTEND PROOF IN Morphism-Id -} 
